...
Expressions are NUMERIC ONLY — no strings, no quotes, no concatenation. To display a fraction like "3/5", use separate placeholders: \`{{num}}/{{den}}\`, NOT \`{{num + '/' + den}}\`.
This applies EVERYWHERE including correctAnswerFormula. For a fraction answer, write: \`"correctAnswerFormula": "{{simpleNum}}/{{simpleDen}}"\`.
